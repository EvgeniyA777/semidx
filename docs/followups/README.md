...
| [015](015_unit_path_change_does_not_reanalyze.md) | open | `bug` | [Plan 012 review](../reports/012_java_semantic_quality_without_query_regression_progress.md#post-closure-review-2026-09-20) | A moved unit is never reanalyzed, so a cross-unit fact survives a visibility boundary the reader can no longer cross; the path became a semantic input at ADR 008. |
| [016](016_java_static_call_rule_narrow_gaps.md) | open | `bug` | [Plan 012 review](../reports/012_java_semantic_quality_without_query_regression_progress.md#post-closure-review-2026-09-20) | An on-demand static import guards nothing, a missing `java.static` label is reported as "not static", and two reason families are unreachable and unfixtured. |
| [017](017_plan_012_external_evidence_reproducibility.md) | open | `process_defect` | [Plan 012 review](../reports/012_java_semantic_quality_without_query_regression_progress.md#post-closure-review-2026-09-20) | The sampling and classification harness behind Plan 012's external numbers is uncommitted and under-described, and the 106-assertion delta assigned to Stage 7 was never accounted for. |
