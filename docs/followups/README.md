...
| [017](017_plan_012_external_evidence_reproducibility.md) | open | `process_defect` | [Plan 012 review](../reports/012_java_semantic_quality_without_query_regression_progress.md#post-closure-review-2026-09-20) | `scripts/java-claim-sample.py` now draws a sample reproducible from its seed alone and reports any unclassified reason, but Plan 012's own numbers were drawn by a selection nobody kept, so they stay unverifiable until a new baseline is measured on a clone. |
