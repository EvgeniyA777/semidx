...
| P1 | Persistent JVM runtime reuse | in_progress | `plans/021`, runtime docs | Runtime-http reuse shipped in Stage 2; finish MCP HTTP profile guidance and hardening benchmarks. |
