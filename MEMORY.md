...
1. Implement `plans/013` Stage 3 according to `ADR-037`: add the typed-relation schema/index substrate with no retrieval behavior change, then add the Clojure producer.
