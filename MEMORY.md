...
- The post-roadmap semantic deepening tranche tracked in `plans/architecture/002_post_roadmap_semantic_deepening_plan.md` is now fully delivered across Stages 1-8.
