...
- Active execution backlog is now tracked in `docs/post-roadmap-semantic-deepening-plan.md`; Stages 1-5 (Clojure lexical/destructuring, Clojure dispatch/protocol, Java inheritance/method-reference, Python decorator/class-scope, and Elixir pipeline/nested-module deepening) are delivered and Stage 6 is the active slice.
