...
- The post-roadmap semantic deepening tranche tracked in `plans/architecture/post-roadmap-semantic-deepening-plan.md` is now fully delivered across Stages 1-8.
