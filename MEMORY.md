...
3. Next tranche is the public graph surface (Stage 4): reuse the same `traverse-relations` contract and bounds instead of defining a second walk, and add the PostgreSQL `semantic_index_relations` projection with parity to the pure kernel.
