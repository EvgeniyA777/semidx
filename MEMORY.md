...
- Active execution backlog is now tracked in `docs/post-roadmap-semantic-deepening-plan.md`; Stage 1 (Clojure lexical/destructuring deepening) is delivered and Stage 2 is the active slice.
