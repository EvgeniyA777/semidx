...
chmod +x scripts/git-hooks/pre-commit scripts/git-hooks/commit-msg scripts/git-hooks/pre-push scripts/check-agent-attribution.sh scripts/check-memory-freshness.sh scripts/check-constitution-freeze.sh
